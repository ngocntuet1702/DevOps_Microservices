# MultiStepWorkflowWithConnectors
...
```bash
MultiStepWorkflowWithConnectors$ sam build
```
...
```bash
MultiStepWorkflowWithConnectors$ sam logs -n StockCheckerFunction --stack-name MultiStepWorkflowWithConnectors --tail
```
...
```bash
MultiStepWorkflowWithConnectors$ cd functions/stock-checker
...
```bash
aws cloudformation delete-stack --stack-name MultiStepWorkflowWithConnectors
```
